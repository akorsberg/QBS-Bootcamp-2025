...
filenames <- list.files(path = "~/Ash's Documents/QBS PhD Program_2024/bootcamp_2025/data_analytics/data_analytics_session1_data", pattern = ".csv")
print(filenames)
```
...
for (file in filenames){
  ...
  histogram <- ggplot(the_file, aes(x=age_var)) + geom_histogram(bins = 20, fill = "darkgreen")
  plot(histogram)
}
```
